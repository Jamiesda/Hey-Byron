...
const styles = StyleSheet.create({
  ...
  continueButton: {
    backgroundColor: 'rgba(59, 130, 246, 0.75)', // Changed to blue color from the button
    paddingVertical: 16,
    borderRadius: 12,
    alignItems: 'center',
    shadowColor: '#000',
  ...
  disabledButton: {
    backgroundColor: 'rgba(0,0,0,0.2)', // Updated for light gradient
  },
  continueText: {
    color: '#FFFFFF', // Changed to white text for blue background
    fontSize: 16,
    fontWeight: '600',
  },
  disabledText: {
